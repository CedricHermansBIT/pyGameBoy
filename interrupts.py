...
def handle_interrupts(MEMORY: list, PC: int, IME: int, SP: int, HALT: int, romtype:int, game: list) -> tuple:
    if IME:
        ...
        if readMem(MEMORY, 0xFFFF, romtype) & readMem(MEMORY, 0xFF0F, romtype):
            if readMem(MEMORY, 0xFFFF, romtype) & 0x01 and readMem(MEMORY, 0xFF0F, romtype) & 0x01:
                #print("VBLANK")
                IME = False
                writeMem(MEMORY, 0xFF0F, readMem(MEMORY, 0xFF0F, romtype) & 0xFE, romtype, game)
                # print(MEMORY[0xFF0F])
                SP-=1
                writeMem(MEMORY, SP, (PC>>8) & 0xFF, 0, game)
                SP-=1
                writeMem(MEMORY, SP, PC & 0xFF, 0, game)
                ...
                #print("LCD STAT")
                IME = False
                writeMem(MEMORY, 0xFF0F, readMem(MEMORY, 0xFF0F, romtype) & 0xFD, romtype, game)
                SP-=1
                writeMem(MEMORY, SP, (PC>>8) & 0xFF, 0, game)
                SP-=1
                writeMem(MEMORY, SP, PC & 0xFF, 0, game)
                ...
                #print("TIMER")
                IME = False
                writeMem(MEMORY, 0xFF0F, readMem(MEMORY, 0xFF0F, romtype) & 0xFB, romtype, game)
                SP-=1
                writeMem(MEMORY, SP, (PC>>8) & 0xFF, 0, game)
                SP-=1
                writeMem(MEMORY, SP, PC & 0xFF, 0, game)
                ...
                #print("SERIAL")
                IME = False
                writeMem(MEMORY, 0xFF0F, readMem(MEMORY, 0xFF0F, romtype) & 0xF7, romtype, game)
                SP-=1
                writeMem(MEMORY, SP, (PC>>8) & 0xFF, 0, game)
                SP-=1
                writeMem(MEMORY, SP, PC & 0xFF, 0, game)
                ...
                print("JOYPAD")
                IME = False
                writeMem(MEMORY, 0xFF0F, readMem(MEMORY, 0xFF0F, romtype) & 0xEF, romtype, game)
                SP-=1
                writeMem(MEMORY, SP, (PC>>8) & 0xFF, 0, game)
                SP-=1
                writeMem(MEMORY, SP, PC & 0xFF, 0, game)
